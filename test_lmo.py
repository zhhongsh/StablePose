...
from datasets.linemod.dataset_lmo import PoseDataset as PoseDataset_lmo
...
parser.add_argument('--resume_posenet', type=str, default='pose_model_23_0.2027222095310724.pth', help='resume PoseNet model')
...
def main():
    ...
    with torch.no_grad():
        for j, data in enumerate(testdataloader, 0):
            ...
            loss, dis, norm_loss, patch_loss, r_pred, t_pred, pred = criterion(pred_r, pred_t, choose_r, target_rt,
    ...
    dataframe.to_csv("./lmo/lmo-ref2.csv", index=False, sep=',')
