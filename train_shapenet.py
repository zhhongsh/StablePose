    ...
    for epoch in range(opt.start_epoch, opt.nepoch):
        ...
        for rep in range(opt.repeat_epoch):
            for i, data in enumerate(dataloader, 0):
                ...
                loss, dis, norm_loss, patch_loss, r_pred, t_pred,pred = criterion(pred_r, pred_t, pred_a,pred_choose, target_rt,
                                                            points, target_pt, model_points,target_mode,target_s)
