...
def main():
    ...
    with torch.no_grad():
        for j, data in enumerate(testdataloader, 0):
            ...
            # np.savetxt('/home/lthpc/yifeis/pose/pose_est_tless_3d/tools/nocs/results/{0}_{1}_pred-icp.txt'.format(str(obj_cate),str(j)),pred_icp)
            # np.savetxt('/home/lthpc/yifeis/pose/pose_est_tless_3d/tools/nocs/results/{0}_{1}_pred.txt'.format(str(obj_cate), str(j)), pred)
            # np.savetxt('/home/lthpc/yifeis/pose/pose_est_tless_3d/tools/nocs/results/{0}_{1}_target.txt'.format(str(obj_cate),str(j)),target)
            # np.savetxt('/home/lthpc/yifeis/pose/pose_est_tless_3d/tools/nocs/results/{0}_{1}_view.txt'.format(str(obj_cate),str(j)),view_point)
        ...
        np.save('/home/lthpc/yifeis/pose/pose_est_tless_3d/tools/nocs/test_results_visual5.npy',dic_visual)
        np.save('/home/lthpc/yifeis/pose/pose_est_tless_3d/tools/nocs/test_results5.npy', dic)
